---
name: canvas
description: "Display HTML content on connected OpenClaw nodes (Mac app, iOS, Android). Use when you need to present web-based visualizations, games, dashboards, or interactive demos on a connected device's canvas view."
