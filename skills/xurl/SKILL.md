        ...
        "install":
          [
            ...
            },
            {
              "id": "go",
              "kind": "go",
              "package": "github.com/xdevplatform/xurl@latest",
              "bins": ["xurl"],
              "label": "Install xurl (go install)",
            },
            {
              "id": "download",
              "kind": "download",
              "url": "https://raw.githubusercontent.com/xdevplatform/xurl/main/install.sh",
              "bins": ["xurl"],
              "label": "Install xurl (shell script)",
            },
          ],
      },
  }
