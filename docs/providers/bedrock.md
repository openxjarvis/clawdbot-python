---
summary: "Use Amazon Bedrock (Converse API) models with OpenClaw Python"
read_when:
  - You want to use Amazon Bedrock models with OpenClaw Python
...
OpenClaw can use **Amazon Bedrock** models via the **Bedrock Converse** streaming provider.
