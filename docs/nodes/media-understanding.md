...
1. **Local CLIs** (audio only; if installed)
   ...
   - `whisper` (Python CLI; `pip install openai-whisper` — downloads models automatically)
...
- CLI fallback: `whisper-cli` (whisper-cpp) or `whisper` (`pip install openai-whisper`).
