...
Workspace: /home/user/openclaw-alfred/
...
Workspace: /home/user/openclaw-baerbel/
Tools: read only
```
...
class BroadcastConfig(TypedDict, total=False):
    strategy: str  # "parallel" | "sequential"
    # Additional keys are peer IDs mapped to agent ID lists
    # e.g., "120363403215116621@g.us": ["alfred", "baerbel"]
```
