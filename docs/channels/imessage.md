...
**See also:**
- [BlueBubbles (recommended)](/channels/bluebubbles) — Preferred iMessage path for new setups.
- [Pairing](/channels/pairing) — iMessage DMs default to pairing mode.
- [Configuration reference](/gateway/configuration-reference#imessage) — Full iMessage field reference.
