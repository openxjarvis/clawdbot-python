...
Voice calls for OpenClaw Python via a plugin. Supports outbound notifications and
...
```bash
pip install openclaw-plugin-voice-call
```
...
pip install -e ./extensions/voice-call
```
