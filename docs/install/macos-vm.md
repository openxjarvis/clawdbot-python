...
- **Dedicated hardware** (Mac mini or Linux box) if you want full control and a **residential IP** for browser automation.
...
4. Point BlueBubbles webhooks at your gateway
